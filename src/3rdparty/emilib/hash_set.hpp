...
// Note: Changes made from the original version of this file are annotated 
//       by a comment with the name of the editor, such as: '// Modified(Crydsch)'
...
#include <iterator>
#include <utility>
#include <stdint.h> // Modified(Crydsch)

// Disable loguru   // Modified(Crydsch)
// #include <loguru.hpp>
